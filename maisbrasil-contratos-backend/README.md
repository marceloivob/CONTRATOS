...
- [Sonar 42811.MAIS-BRASIL.CONTRATOS-BACKEND](https://sonarqube.aic.serpro/dashboard?id=42811.MAIS-BRASIL.CONTRATOS-BACKEND)
...
To build the final jar and optimize the maisbrasilContratosBackend application for production, run:
