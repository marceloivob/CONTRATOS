...
@Component
@RequestScope
public class EmissaoAIOAuthenticatorFilter implements ClientRequestFilter {

	@Autowired
	private EmissaoAIOAuthenticatorHeaderGenerator emissaoAIOAuthenticatorHeaderGenerator;

	/**
	 * Construtor Padrão para o CDI
	 */
	public EmissaoAIOAuthenticatorFilter() {
		// noop
	}
	...
	public void filter(ClientRequestContext requestContext) throws IOException {
		...
		final String basicAuthentication = emissaoAIOAuthenticatorHeaderGenerator.create(usuarioLogado);
