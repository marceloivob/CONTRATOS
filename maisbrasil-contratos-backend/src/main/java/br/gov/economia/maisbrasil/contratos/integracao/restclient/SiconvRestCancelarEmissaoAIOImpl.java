...
@RequestScope
@Slf4j
public class SiconvRestCancelarEmissaoAIOImpl implements SiconvRest {

	@Autowired
	private CancelamentoEmissaoAIOAuthenticatorFilter cancelamentoEmissaoAIOAuthenticatorFilter;
	...
	public AtualizarHistoricoResponse atualizarHistorico(Long propostaFk, String justificativa, boolean batch) {
		...
		client.register(cancelamentoEmissaoAIOAuthenticatorFilter);
