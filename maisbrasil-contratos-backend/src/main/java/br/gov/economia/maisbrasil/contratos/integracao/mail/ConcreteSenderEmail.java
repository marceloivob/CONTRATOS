...
public class ConcreteSenderEmail implements SenderEmail {
	...
	private Properties getMailConfigProperties() {
		...
		config.put(MAIL_SMTP_HOST_PROPERTY, env.getProperty("integrations.PRIVATE.MAIL.remote-host"));
		config.put(MAIL_SMTP_PORT_PROPERTY, env.getProperty("integrations.PRIVATE.MAIL.remote-port"));
		config.put(MAIL_FROM_PROPERTY, env.getProperty("integrations.PRIVATE.MAIL.from"));
