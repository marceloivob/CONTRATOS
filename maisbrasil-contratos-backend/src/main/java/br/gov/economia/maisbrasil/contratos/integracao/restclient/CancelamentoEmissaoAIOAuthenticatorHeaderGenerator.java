...
@Component
@RequestScope
public class CancelamentoEmissaoAIOAuthenticatorHeaderGenerator {
	...
	public String create(SiconvUser usuario) {
		...
		try {
			...
			String headerAuthenticator = String.format("Basic %s:%s", cpf, cpfEmTextoLivreESecretKeyEmBase64);
