...
public class BasicAuthenticatorHeaderGenerator {
	...
	public String create(String usuario) {
		...
		try {
			...
			String cpfESecretKeyEmMD5 = getMD5(usuario.concat(secretKeyEmBase64));

			String cpfEmTextoLivreESecretKeyEmBase64 = transformInBase64(cpfESecretKeyEmMD5);

			String headerAuthenticator = String.format("Basic %s:%s", usuario,
