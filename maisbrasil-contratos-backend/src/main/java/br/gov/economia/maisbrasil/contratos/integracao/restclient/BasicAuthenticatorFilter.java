...
public class BasicAuthenticatorFilter implements ClientRequestFilter {
	...
	public static final String SISTEMA_BACKEND = "maisbrasil-contratos-backend";	
	...
	public void filter(ClientRequestContext requestContext) throws IOException {
		...
		final String basicAuthentication = basicAuthenticatorHeaderGenerator.create(SISTEMA_BACKEND);
