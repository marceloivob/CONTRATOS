...
@Component({
  selector: 'nao-existe-vrpl-aceito-error',
  templateUrl: './nao-existe-vrpl-aceito-error.component.html'
})
export class NaoExisteVRPLAceitoComponent extends BaseComponent {
