...
@Component({
  selector: 'app-proposta-nao-encontrada-vrpl',
  templateUrl: './proposta-nao-encontrada-vrpl.component.html'
})
export class PropostaNaoEncontradaVrplComponent  extends BaseComponent  {
